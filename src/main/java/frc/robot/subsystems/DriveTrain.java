...
public class DriveTrain extends SubsystemBase {
  ...
  private WPI_TalonFX m_moteurArriereGauche = new WPI_TalonFX(Constants.Drivetrain.kMoteurArriereGauchePort);
  private WPI_TalonFX m_moteurArriereDroit = new WPI_TalonFX(Constants.Drivetrain.kMoteurArriereDroitPort);

  private final MotorControllerGroup m_groupeGauche = new MotorControllerGroup(m_moteurAvantGauche, m_moteurArriereGauche);
  private final MotorControllerGroup m_groupeDroit = new MotorControllerGroup(m_moteurAvantDroit, m_moteurArriereDroit);
  ...
  public DriveTrain() {
    /**Reinitialisation de tous les moteurs de deplacement a leurs valeurs par defaut*/
     ...
     m_moteurArriereGauche.configFactoryDefault();  
     m_moteurAvantDroit.configFactoryDefault();  
     m_moteurArriereDroit.configFactoryDefault();

     m_moteurAvantGauche.setNeutralMode(NeutralMode.Brake);
     m_moteurArriereDroit.setNeutralMode(NeutralMode.Brake);
     m_moteurAvantDroit.setNeutralMode(NeutralMode.Brake);
     m_moteurArriereGauche.setNeutralMode(NeutralMode.Brake);
    ...
    //  m_moteurArriereDroit.configOpenloopRamp(0.5);
     ...
     m_moteurArriereGauche.follow(m_moteurAvantGauche);
     m_moteurArriereDroit.follow(m_moteurAvantDroit);
  ...
  private double getLeftPosition() {
    ...
    return (m_moteurArriereGauche.getSelectedSensorPosition() + m_moteurAvantGauche.getSelectedSensorPosition()) / 2.0d;
  }
  private double getRightPosition() {
    if (RobotBase.isSimulation()) {
      return (backRightSimMotor.getSelectedSensorPosition() + frontRightSimMotor.getSelectedSensorPosition()) / 2.0d;
    }
    return (m_moteurArriereDroit.getSelectedSensorPosition() + m_moteurAvantDroit.getSelectedSensorPosition()) / 2.0d;
  }
...
/**
  ...
  public double getLeftVelocityTicksPerDs() {
    ...
    return (m_moteurAvantGauche.getSelectedSensorVelocity() + m_moteurArriereGauche.getSelectedSensorVelocity()) / 2.0d;
  }
  public double getRightVelocityTicksPerDs() {
    ...
    return (m_moteurAvantDroit.getSelectedSensorVelocity() + m_moteurArriereDroit.getSelectedSensorVelocity()) / 2.0d;
  }
  /**
 ...
 public void periodic() {
  ...
  public void resetEncoders() {
    ...
    m_moteurArriereGauche.setSelectedSensorPosition(0);
    m_moteurArriereDroit.setSelectedSensorPosition(0);
  }
